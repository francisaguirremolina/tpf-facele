/**
ORM function class for: ComprobanteAsJSON
Generated: 2025-10-21 15:27:38
Convierte un comprobante a su representación JSON
*/
...
public class SPC_ComprobanteAsJSON extends AbstractFunction {
    ...
    public static ResultSet execute(Connection p_conn,
        ...
        String l_IdDocumentoFE = sqlQuote(p_IdDocumentoFE);
            ...
            String l_sql = "select * from facele.spc_ComprobanteAsJSON(" + l_IdDocumentoFE + ")";
            if (isDebug()) {
