/**
ORM function class for: montoescrito_generico
...
public class SPC_montoescrito_generico extends AbstractFunction {

    public static ResultSet execute(Connection p_conn,
            Long p_centavos) throws Exception {
        String l_centavos = sqlQuote(p_centavos);

            String l_sql = "select * from facele.spc_montoescrito_generico(" + l_centavos + ")";
            if (isDebug()) {
