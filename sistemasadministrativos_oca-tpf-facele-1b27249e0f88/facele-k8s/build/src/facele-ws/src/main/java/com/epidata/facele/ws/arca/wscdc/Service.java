 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://servicios1.afip.gob.ar/wscdc/", 
        wsdlLocation = "file://wsdl/wscdc.wsdl")
    ...
    extends jakarta.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://servicios1.afip.gob.ar/wscdc/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new File("wsdl/wscdc.wsdl").toURI().toURL();
    ...
    public ServiceSoap getServiceSoap() {
        return super.getPort(new QName("http://servicios1.afip.gob.ar/wscdc/", "ServiceSoap"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios1.afip.gob.ar/wscdc/", "ServiceSoap"), ServiceSoap.class, features);
    }
    ...
    public ServiceSoap getServiceSoap12() {
        return super.getPort(new QName("http://servicios1.afip.gob.ar/wscdc/", "ServiceSoap12"), ServiceSoap.class);
    }
    ...
    public ServiceSoap getServiceSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios1.afip.gob.ar/wscdc/", "ServiceSoap12"), ServiceSoap.class, features);
    }
