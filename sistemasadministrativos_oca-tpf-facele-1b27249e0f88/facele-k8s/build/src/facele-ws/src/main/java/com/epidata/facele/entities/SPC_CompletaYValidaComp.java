/**
ORM function class for: CompletaYValidaComp
Generated: 2025-10-21 15:27:38
Completa y valida un comprobante: su cabecera y todos sus registros asociados.
*/
...
public class SPC_CompletaYValidaComp extends AbstractFunction {
    ...
    public static ResultSet execute(Connection p_conn,
        ...
        String l_IdDocumentoFE = sqlQuote(p_IdDocumentoFE);
            ...
            String l_sql = "select * from facele.spc_CompletaYValidaComp(" + l_IdDocumentoFE + ")";
            if (isDebug()) {
